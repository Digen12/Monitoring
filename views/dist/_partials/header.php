...
<head>
  ...
  <title><?php echo $title; ?> &mdash;Monitoring</title>
  ...
  <!-- CSS Libraries -->
  <?php if (  $this->uri->segment(1) == "C_dosen" ||  $this->uri->segment(1) == "c_dosen" || $this->uri->segment(1) == "C_mhs" ||  $this->uri->segment(1) == "c_mhs" || $this->uri->segment(1) == "C_survei" ||  $this->uri->segment(1) == "c_survei" || $this->uri->segment(1) == "C_bimbingan" ||  $this->uri->segment(1) == "c_bimbingan" ||  $this->uri->segment(2) == "get_mhs" ||  $this->uri->segment(2) == "get_mhs_v"||  $this->uri->segment(2) == "vmateri") { ?>
...
<?php
}elseif ($this->uri->segment(2) == "modules_datatables" || $this->uri->segment(1) == "C_dosen" ) { ?>
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/datatables/datatables.min.css">
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/datatables/DataTables-1.10.16/css/dataTables.bootstrap4.min.css">
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/datatables/Select-1.2.4/css/select.bootstrap4.min.css">
<?php
...
<?php
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/owlcarousel2/dist/assets/owl.theme.default.min.css">
<?php
}elseif ($this->uri->segment(2) == "modules_toastr"||$this->uri->segment(2) == "auth_register" ) { ?>
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/izitoast/css/iziToast.min.css">
<?php
