                  ...
                  <div class="row">
                   <div class="form-group col-4">
                      <select id="mins" class="form-control">
                        <option value="">- Filter berdasarkan Dosen -</option>
                      </select>
                    </div>
                    <div class="form-group col-4">
                    ...
                    <div class="form-group col-4">
                      <select id="max" class="form-control">
                        <option value="">- Filter berdasarkan TA -</option>
                      ...
                      <table class="table table-striped" id="data-table">
                        <thead>                                 
                          <tr>
                            ...
                            <th>Aktivitas</th>
                            <th>Pertemuan </th>
                            <th style="display: none;">Tgl Pertemuan</th>
                            <th style="display: none;">Judul Bahasan</th>
                            <th style="display: none;">Materi</th>
                            <th>Status</th>
   ...
   $.fn.dataTable.ext.search.push(
    function( settings, data, dataIndex ) {
        var min = $('#min').val();
         var mins = $('#mins').val();
         var max = $('#max').val();
        var age =  data[15]; // use data for the age column
        var age2 =  data[14];
        var age3 =  data[10];
         var age4 =  data[16];
         var kosong = '';
          // alert(mins);
            if (max==kosong && min==kosong  && mins==kosong  )  {
       
            if (kosong==age4) {
              return true;
            }
        } else if (max!=kosong && min!=kosong&& mins!=kosong) {
          if (mins == age3 && max == age2 && min ==age) {
   ...
   $(document).ready(function () {
     ...
     $.ajax({
                        ...
                        success: function (data) {
                              $('#mins').find('option').not(':first-child').remove();
                               $.each(data, function ( index,data) {
                               
                            
                            $('#mins').append('<option value="' + data['nid'] + '">'  + data['nid'] + ' - '  + data['nama_depan'] + '</option>'); 
    ...
    // Event listener to the two range filtering inputs to redraw on input
           ...
           $('#data-table').DataTable( {
                "ajax": {
                    "url": "<?php echo base_url('C_bimbingan/getdata_materi_rekap2') ?>",
                    "dataSrc": ""
                },dom: 'Bfrtip',
            buttons: [
