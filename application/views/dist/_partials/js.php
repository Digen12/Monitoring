...
<?php
}elseif ($this->uri->segment(2) == "modules_toastr" || $this->uri->segment(2) == "auth_register" ||$this->uri->segment(2) == "auth_login"  ) { ?>
  <script src="<?php echo base_url(); ?>assets/modules/izitoast/js/iziToast.min.js"></script>
<?php
